...
public:
   ...
   ///@post  If there isn't any room in the array for the new
   ///	entry, then the array will be doubled in size. Independently,
   ///	the new entry is also added to the array.
   ///@param newEntry  The object to be added as a new entry.
   ///@return  True if addition was successful, or false if not.
   ///
   virtual bool addWithResize(const ItemType& newEntry) = 0;
