...
/// ADT bag: Link-based implementation. @file LinkedBag.cpp
...
template<class ItemType>
bool LinkedBag<ItemType>::addWithResize(const ItemType& newEntry)
{
...
vector<ItemType> LinkedBag<ItemType>::toVector() const
{
   ...
   int counter = 0;
	...
	//This loops through all elements of the Linked List and
	//	puts the items into a vector.
